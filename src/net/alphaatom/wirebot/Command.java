...
public abstract class Command {
	 ...
	 * broadcaster - the display-name is the same as the channel name.
	 * 
	...
	public boolean userHasElevation(Map<String, String> cmdinfo) {
		 return (!cmdinfo.get("user-type").equals("") || cmdinfo.get("display-name").equalsIgnoreCase(cmdinfo.get("channel").substring(1)));
	}
